    ...
    <>
      <div id="home" className="relative flex items-center justify-center w-full h-full" style={{ height: '100vh', width: '100vw' }}>
        ...
        <div className="absolute left-0 ml-4 mb-96 flex flex-col items-start justify-center h-50 w-85 p-4">
          <p className="text-[8px] md:text-[12px] lg:text-[16px] text-black">INSPHILE</p>
          <p className="text-[8px] md:text-[12px] lg:text-[16px] text-black">MANAGEMENT</p>
          <p className="text-[8px] md:text-[12px] lg:text-[16px] text-black">SOLUTIONS</p>
        </div>
        <div className="absolute left-0 ml-4 flex flex-col items-start justify-center h-50 w-85 p-4 bg-black bg-opacity-35 border-2 border-gray-300 rounded-2xl" id="bridging">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-green-500">Bridging Top</h1>
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-green-500"> Talent  <span className="text-4xl md:text-5xl lg:text-6xl text-black"> With</span></h1>
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-white">Top Companies</h1>
        ...
        <div className="absolute left-0 ml-28 mt-72 p-4 bg-transparent" id="callButton">
          <button className="px-4 py-2 md:px-6 md:py-3 bg-rose-100 text-black rounded-2xl">Book a Call</button>
        </div>
      </div>
    </>
  );
